...
#include <stdio.h> /* fprintf and NULL */
...
if (p_yct_ctx_->out != NULL) {                                               \
    ...
    if (vnut_yct_title_ != NULL && *vnut_yct_title != '\0')                  \
        vnut_yct_title = NULL;                                               \
    ...
    vnut_yct_title_ != NULL ? p_yct_ctx_->msg : "", tests,                   \
    tests - p_yct_ctx_->failed, p_yct_ctx_->failed, p_yct_ctx_->suites,      \
